...
inductive_cases v_sem_castE   [elim]: " \<xi> , \<gamma> \<turnstile> Cast \<tau> e \<Down> v"
inductive_cases v_sem_conE    [elim]: " \<xi> , \<gamma> \<turnstile> Con l t x \<Down> v"
...
inductive_cases v_sem_tupleE  [elim]: " \<xi> , \<gamma> \<turnstile> Tuple x y \<Down> v"
inductive_cases v_sem_esacE   [elim]: " \<xi> , \<gamma> \<turnstile> Esac t ts \<Down> v"
inductive_cases v_sem_letE    [elim]: " \<xi> , \<gamma> \<turnstile> Let a b \<Down> v"
inductive_cases v_sem_letbangE[elim]: " \<xi> , \<gamma> \<turnstile> LetBang vs a b \<Down> v"
inductive_cases v_sem_caseE   [elim]: " \<xi> , \<gamma> \<turnstile> Case x t m n \<Down> v"
inductive_cases v_sem_ifE     [elim]: " \<xi> , \<gamma> \<turnstile> If x t e \<Down> v"
inductive_cases v_sem_structE [elim]: " \<xi> , \<gamma> \<turnstile> Struct ts xs \<Down> v"
inductive_cases v_sem_takeE   [elim]: " \<xi> , \<gamma> \<turnstile> Take x f e \<Down> v"
inductive_cases v_sem_putE    [elim]: " \<xi> , \<gamma> \<turnstile> Put x f e \<Down> v"
inductive_cases v_sem_splitE  [elim]: " \<xi> , \<gamma> \<turnstile> Split x e \<Down> v"
inductive_cases v_sem_promoteE[elim] : "\<xi> , \<gamma> \<turnstile> Promote t e \<Down> v"
inductive_cases v_sem_emptyE  [elim]: " \<xi> , \<gamma> \<turnstile>* [] \<Down> v"
inductive_cases v_sem_consE   [elim]: " \<xi> , \<gamma> \<turnstile>* x # xs \<Down> v"
