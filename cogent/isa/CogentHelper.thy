...
fun termName (Const (@{const_name AFun}, _) $ _ $ _)          = "AFun"
  ...
  | termName (Const (@{const_name CustomInt}, _) $ _ $ _)     = "CustomInt"
  | termName (Const (@{const_name SLit}, _) $ _)              = "SLit"
  | termName (Const (@{const_name Cast}, _) $ _ $ _)          = "Cast"
  | termName (Const (@{const_name CustomDCast}, _) $ _ $ _)   = "CustomDCast"
  | termName (Const (@{const_name CustomUCast}, _) $ _ $ _)   = "CustomUCast"
