...
flags =
  ...
  , Option []         ["fno-records-permutation"] 3 (NoArg set_flag_fnoRecordsPermutation) "(default) reverse of --frecords-permutation"
  ...
  , Option []         ["frecords-permutation"] 3 (NoArg set_flag_frecordsPermutation)      "reorder records fields lexicographically"
