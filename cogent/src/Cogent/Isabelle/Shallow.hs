...
newtype SG b a = SG { runSG :: RWS SGTables [Warning] StateGen a }
...
findShortType :: (Show b,Eq b) => Bool -> CC.Type t b -> SG b (CC.Type t b)
...
shallowTypeDefSaveSyn:: (Show b,Eq b) => TypeName -> [TyVarName] -> CC.Type t b -> SG b [TheoryDecl I.Type I.Term]
...
shallowTypeFromTable :: (Show b,Eq b)
                     => SG b ([TheoryDecl I.Type I.Term], [TheoryDecl I.Type I.Term], MapTypeName)
