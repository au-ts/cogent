...
-- TODO: Remove InDecl (because there can be unnamed DataLayouts directly attached to types)
-- TODO: Reverse the direction of paths so program fragments can be checked independently of their context.
data DataLayoutPath
