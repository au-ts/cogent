...
newtype Mono b x = Mono { runMono :: RWS (Instance b)
                                         ([Warning], [Definition PosTypedExpr VarName b], [(Type 'Zero b, String)], [Pragma_ b])
                                         (FunMono b, InstMono b)
                                         x }
                 deriving (Functor, Applicative, Monad,
                           MonadReader (Instance b),
                           MonadWriter ([Warning], [Definition PosTypedExpr VarName b], [(Type 'Zero b, String)], [Pragma_ b]),
...
mono :: forall b. (Ord b)
     ...
     -> ((FunMono b, InstMono b), ([Warning], [Definition PosTypedExpr VarName b], [(Type 'Zero b, String)], [Pragma_ b]))
