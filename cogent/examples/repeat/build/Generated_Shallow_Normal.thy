...
where
  "binarySearch ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 T0.p1\<^sub>f) (\<lambda>(arr,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 T0.p2\<^sub>f) (\<lambda>(v,ds\<^sub>2). HOL.Let ((wordarray_length :: 32 word WordArray \<Rightarrow> 32 word) arr) (\<lambda>len. HOL.Let (ucast len :: 64 word) (\<lambda>an\<^sub>7\<^sub>4. HOL.Let searchStop (\<lambda>an\<^sub>7\<^sub>6. HOL.Let searchNext (\<lambda>an\<^sub>7\<^sub>7. HOL.Let (0 :: 32 word) (\<lambda>an\<^sub>7\<^sub>9. HOL.Let (T0.make an\<^sub>7\<^sub>9 len) (\<lambda>an\<^sub>7\<^sub>8. HOL.Let (T0.make arr v) (\<lambda>an\<^sub>8\<^sub>1. HOL.Let (RepParam.make an\<^sub>7\<^sub>4 an\<^sub>7\<^sub>6 an\<^sub>7\<^sub>7 an\<^sub>7\<^sub>8 an\<^sub>8\<^sub>1) (\<lambda>args. HOL.Let ((repeat :: (64 word, ((32 word, 32 word) T0, (32 word WordArray, 32 word) T0) StepParam \<Rightarrow> bool, ((32 word, 32 word) T0, (32 word WordArray, 32 word) T0) StepParam \<Rightarrow> (32 word, 32 word) T0, (32 word, 32 word) T0, (32 word WordArray, 32 word) T0) RepParam \<Rightarrow> (32 word, 32 word) T0) args) (\<lambda>an\<^sub>8\<^sub>4. HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t an\<^sub>8\<^sub>4 T0.p1\<^sub>f) (\<lambda>(l,ds\<^sub>3). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>3 T0.p2\<^sub>f) (\<lambda>(r,ds\<^sub>4). l)))))))))))))"

definition
  myexp :: "(32 word, 32 word) T0 \<Rightarrow> 32 word"
where
  "myexp ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 T0.p1\<^sub>f) (\<lambda>(a,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 T0.p2\<^sub>f) (\<lambda>(b,ds\<^sub>2). HOL.Let (ucast b :: 64 word) (\<lambda>an\<^sub>8\<^sub>9. HOL.Let expstop (\<lambda>an\<^sub>9\<^sub>1. HOL.Let expstep (\<lambda>an\<^sub>9\<^sub>2. HOL.Let (1 :: 32 word) (\<lambda>an\<^sub>9\<^sub>3. HOL.Let (RepParam.make an\<^sub>8\<^sub>9 an\<^sub>9\<^sub>1 an\<^sub>9\<^sub>2 an\<^sub>9\<^sub>3 a) (\<lambda>args. (repeat :: (64 word, (32 word, 32 word) StepParam \<Rightarrow> bool, (32 word, 32 word) StepParam \<Rightarrow> 32 word, 32 word, 32 word) RepParam \<Rightarrow> 32 word) args)))))))"

definition
  mylog2 :: "64 word \<Rightarrow> 64 word"
where
  "mylog2 ds\<^sub>0 \<equiv> HOL.Let ds\<^sub>0 (\<lambda>n. HOL.Let log2stop (\<lambda>an\<^sub>9\<^sub>7. HOL.Let log2step (\<lambda>an\<^sub>9\<^sub>8. HOL.Let (1 :: 64 word) (\<lambda>an\<^sub>1\<^sub>0\<^sub>0. HOL.Let (0 :: 64 word) (\<lambda>an\<^sub>1\<^sub>0\<^sub>1. HOL.Let (T0.make an\<^sub>1\<^sub>0\<^sub>0 an\<^sub>1\<^sub>0\<^sub>1) (\<lambda>an\<^sub>9\<^sub>9. HOL.Let (RepParam.make n an\<^sub>9\<^sub>7 an\<^sub>9\<^sub>8 an\<^sub>9\<^sub>9 n) (\<lambda>args. HOL.Let ((repeat :: (64 word, ((64 word, 64 word) T0, 64 word) StepParam \<Rightarrow> bool, ((64 word, 64 word) T0, 64 word) StepParam \<Rightarrow> (64 word, 64 word) T0, (64 word, 64 word) T0, 64 word) RepParam \<Rightarrow> (64 word, 64 word) T0) args) (\<lambda>an\<^sub>1\<^sub>0\<^sub>3. HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t an\<^sub>1\<^sub>0\<^sub>3 T0.p1\<^sub>f) (\<lambda>(a,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 T0.p2\<^sub>f) (\<lambda>(b,ds\<^sub>2). b))))))))))"
