...
where
  "searchStop \<equiv> Take (Var 0) 0 (Take (Var 1) 1 (Take (Var 2) 0 (Take (Var 1) 1 (Take (Var 4) 0 (Take (Var 1) 1 (Let (App (AFun ''wordarray_length_0'' []) (Var 2)) (Let (Lit (LU32 0)) (Let (Struct [TCon ''WordArray'' [TPrim (Num U32)] (Boxed ReadOnly undefined), TPrim (Num U32), TPrim (Num U32)] [Var 4, Var 8, Var 0]) (Let (App (AFun ''wordarray_get_0'' []) (Var 0)) (Let (Prim (Ge U32) [Var 10, Var 8]) (If (Var 0) (Lit (LBool True)) (Lit (LBool False)))))))))))))"
...
where
  "searchNext \<equiv> Take (Var 0) 0 (Take (Var 1) 1 (Take (Var 2) 0 (Take (Var 1) 1 (Take (Var 4) 0 (Take (Var 1) 1 (Let (Prim (Minus U32) [Var 4, Var 6]) (Let (Lit (LU32 2)) (Let (Prim (Divide U32) [Var 1, Var 0]) (Let (Prim (Plus U32) [Var 9, Var 0]) (Let (Lit (LU32 0)) (Let (Struct [TCon ''WordArray'' [TPrim (Num U32)] (Boxed ReadOnly undefined), TPrim (Num U32), TPrim (Num U32)] [Var 7, Var 1, Var 0]) (Let (App (AFun ''wordarray_get_0'' []) (Var 0)) (Let (Prim (Lt U32) [Var 0, Var 7]) (If (Var 0) (Let (Lit (LU32 1)) (Let (Prim (Plus U32) [Var 5, Var 0]) (Struct [TPrim (Num U32), TPrim (Num U32)] [Var 0, Var 14]))) (Struct [TPrim (Num U32), TPrim (Num U32)] [Var 14, Var 4])))))))))))))))"
...
Val (KindingTacs [(RTac @{thm typing_helper_14})]),
StepUp,
Val (TypingTacs [(RTac @{thm typing_app}),(SplitsTac [SOME [(RTac @{thm split_comp.left}),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_20})],SOME [(RTac @{thm split_comp.left}),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_21})],SOME [(RTac @{thm split_comp.right}),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_22})],NONE]),(RTac @{thm typing_afun'}),(SimpTac ([@{thm \<Xi>_def},@{thm wordarray_length_0_type_def[unfolded abbreviated_type_defs]}],[])),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_24}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [@{thm typing_helper_14},@{thm typing_helper_19}]),(RTac @{thm typing_var}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [@{thm typing_helper_17}]),(SimpSolveTac ([],[]))]),
StepDown,
StepDown,
Val (KindingTacs [(RTac @{thm typing_helper_14})]),
StepUp,
...
Val (KindingTacs [(RTac @{thm typing_helper_14})]),
StepUp,
Val (TypingTacs [(RTac @{thm typing_app}),(SplitsTac [NONE,SOME [(RTac @{thm split_comp.left}),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_21})],SOME [(RTac @{thm split_comp.right}),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_22})],NONE]),(RTac @{thm typing_afun'}),(SimpTac ([@{thm \<Xi>_def},@{thm wordarray_length_0_type_def[unfolded abbreviated_type_defs]}],[])),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_24}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [@{thm typing_helper_19}]),(RTac @{thm typing_var}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [@{thm typing_helper_17}]),(SimpSolveTac ([],[]))]),
StepDown,
StepDown,
Val (KindingTacs [(RTac @{thm typing_helper_5})]),
StepUp,
...
StepUp,
Val (TypingTacs [(RTac @{thm typing_fun'}),(RTac @{thm searchStop_typecorrect[simplified searchStop_type_def searchStop_typetree_def abbreviated_type_defs, simplified]}),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_32}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [])]),
StepDown,
StepDown,
Val (KindingTacs [(RTac @{thm typing_helper_33})]),
StepUp,
Val (TypingTacs [(RTac @{thm typing_fun'}),(RTac @{thm searchNext_typecorrect[simplified searchNext_type_def searchNext_typetree_def abbreviated_type_defs, simplified]}),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_32}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [])]),
StepDown,
StepDown,
Val (KindingTacs [(RTac @{thm typing_helper_14})]),
StepUp,
...
StepUp,
Val (TypingTacs [(RTac @{thm typing_fun'}),(RTac @{thm expstop_typecorrect[simplified expstop_type_def expstop_typetree_def abbreviated_type_defs, simplified]}),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_38}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [])]),
StepDown,
StepDown,
...
StepUp,
Val (TypingTacs []),
Val (TypingTacs [(RTac @{thm typing_app}),(SplitsTac [SOME [(RTac @{thm split_comp.right}),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_41})],NONE]),(RTac @{thm typing_afun'}),(SimpTac ([@{thm \<Xi>_def},@{thm repeat_1_type_def[unfolded abbreviated_type_defs]}],[])),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_42}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac []),(RTac @{thm typing_var}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [@{thm typing_helper_40}]),(SimpSolveTac ([],[]))]),
StepUp,
StepUp,
StepUp,
StepUp,
...
StepUp,
Val (TypingTacs [(RTac @{thm typing_fun'}),(RTac @{thm log2stop_typecorrect[simplified log2stop_type_def log2stop_typetree_def abbreviated_type_defs, simplified]}),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_44}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [])]),
StepDown,
StepDown,
Val (KindingTacs [(RTac @{thm typing_helper_45})]),
StepUp,
Val (TypingTacs [(RTac @{thm typing_fun'}),(RTac @{thm log2step_typecorrect[simplified log2step_type_def log2step_typetree_def abbreviated_type_defs, simplified]}),(RTac @{thm typing_helper_23}),(SimpSolveTac ([],[])),(SimpSolveTac ([],[])),(RTac @{thm type_wellformed_prettyI}),(SimpTac ([],@{thms type_wellformed.simps})),(RTac @{thm typing_helper_44}),(SimpTac ([@{thm empty_def}],[])),(WeakeningTac [])]),
StepDown,
StepDown,
Val (KindingTacs [(RTac @{thm typing_helper_5})]),
StepUp,
