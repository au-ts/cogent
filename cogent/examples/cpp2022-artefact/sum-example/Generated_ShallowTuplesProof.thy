...
lemma shallow_tuples_rule_make__WordArrayMapNoBreakP [ShallowTuplesRules_Generated]:
  ...
  \<rbrakk> \<Longrightarrow> shallow_tuples_rel (Generated_ShallowShared.WordArrayMapNoBreakP.make x1 x2 x3 x4 x5 x6) \<lparr>Generated_ShallowShared_Tuples.WordArrayMapNoBreakP.arr\<^sub>f = xt1, frm\<^sub>f = xt2 , to\<^sub>f = xt3 , f\<^sub>f = xt4 , acc\<^sub>f = xt5 , obsv\<^sub>f = xt6\<rparr>"
...
lemma shallow_tuples_rule__WordArrayMapNoBreakP__arr\<^sub>f [ShallowTuplesThms_Generated]:
...
lemma shallow_tuples_rule__WordArrayMapNoBreakP__frm\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3, 'x4, 'x5, 'x6) Generated_ShallowShared.WordArrayMapNoBreakP) (xt :: ('xt1, 'xt2, 'xt3, 'xt4, 'xt5, 'xt6) Generated_ShallowShared_Tuples.WordArrayMapNoBreakP) \<Longrightarrow>
  ...
  by (simp add: shallow_tuples_rel_WordArrayMapNoBreakP_def)
lemma shallow_tuples_rule__WordArrayMapNoBreakP__to\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3, 'x4, 'x5, 'x6) Generated_ShallowShared.WordArrayMapNoBreakP) (xt :: ('xt1, 'xt2, 'xt3, 'xt4, 'xt5, 'xt6) Generated_ShallowShared_Tuples.WordArrayMapNoBreakP) \<Longrightarrow>
  ...
  by (simp add: shallow_tuples_rel_WordArrayMapNoBreakP_def)
lemma shallow_tuples_rule__WordArrayMapNoBreakP__f\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3, 'x4, 'x5, 'x6) Generated_ShallowShared.WordArrayMapNoBreakP) (xt :: ('xt1, 'xt2, 'xt3, 'xt4, 'xt5, 'xt6) Generated_ShallowShared_Tuples.WordArrayMapNoBreakP) \<Longrightarrow>
  ...
  by (simp add: shallow_tuples_rel_WordArrayMapNoBreakP_def)
lemma shallow_tuples_rule__WordArrayMapNoBreakP__acc\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3, 'x4, 'x5, 'x6) Generated_ShallowShared.WordArrayMapNoBreakP) (xt :: ('xt1, 'xt2, 'xt3, 'xt4, 'xt5, 'xt6) Generated_ShallowShared_Tuples.WordArrayMapNoBreakP) \<Longrightarrow>
  ...
  by (simp add: shallow_tuples_rel_WordArrayMapNoBreakP_def)
lemma shallow_tuples_rule__WordArrayMapNoBreakP__obsv\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3, 'x4, 'x5, 'x6) Generated_ShallowShared.WordArrayMapNoBreakP) (xt :: ('xt1, 'xt2, 'xt3, 'xt4, 'xt5, 'xt6) Generated_ShallowShared_Tuples.WordArrayMapNoBreakP) \<Longrightarrow>
   shallow_tuples_rel (Generated_ShallowShared.WordArrayMapNoBreakP.obsv\<^sub>f x) (Generated_ShallowShared_Tuples.WordArrayMapNoBreakP.obsv\<^sub>f xt)"
  by (simp add: shallow_tuples_rel_WordArrayMapNoBreakP_def)
...
lemma shallow_tuples_rule_make__WordArrayPutP [ShallowTuplesRules_Generated]:
  "\<lbrakk>
     ...
     shallow_tuples_rel x2 xt2;
     shallow_tuples_rel x3 xt3
  \<rbrakk> \<Longrightarrow> shallow_tuples_rel (Generated_ShallowShared.WordArrayPutP.make x1 x2 x3) \<lparr>Generated_ShallowShared_Tuples.WordArrayPutP.arr\<^sub>f = xt1, idx\<^sub>f = xt2 , val\<^sub>f = xt3\<rparr>"
...
lemma shallow_tuples_rule__WordArrayPutP__arr\<^sub>f [ShallowTuplesThms_Generated]:
...
lemma shallow_tuples_rule__WordArrayPutP__idx\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3) Generated_ShallowShared.WordArrayPutP) (xt :: ('xt1, 'xt2, 'xt3) Generated_ShallowShared_Tuples.WordArrayPutP) \<Longrightarrow>
  ...
  by (simp add: shallow_tuples_rel_WordArrayPutP_def)
lemma shallow_tuples_rule__WordArrayPutP__val\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3) Generated_ShallowShared.WordArrayPutP) (xt :: ('xt1, 'xt2, 'xt3) Generated_ShallowShared_Tuples.WordArrayPutP) \<Longrightarrow>
   shallow_tuples_rel (Generated_ShallowShared.WordArrayPutP.val\<^sub>f x) (Generated_ShallowShared_Tuples.WordArrayPutP.val\<^sub>f xt)"
  by (simp add: shallow_tuples_rel_WordArrayPutP_def)
...
lemma shallow_tuples_rule_make__ElemAO [ShallowTuplesRules_Generated]:
  "\<lbrakk>
     ...
     shallow_tuples_rel x2 xt2;
     shallow_tuples_rel x3 xt3
  \<rbrakk> \<Longrightarrow> shallow_tuples_rel (Generated_ShallowShared.ElemAO.make x1 x2 x3) \<lparr>Generated_ShallowShared_Tuples.ElemAO.elem\<^sub>f = xt1, acc\<^sub>f = xt2 , obsv\<^sub>f = xt3\<rparr>"
  by (simp add: shallow_tuples_rel_ElemAO_def Generated_ShallowShared.ElemAO.defs Generated_ShallowShared_Tuples.ElemAO.defs)
lemma shallow_tuples_rule__ElemAO__elem\<^sub>f [ShallowTuplesThms_Generated]:
...
lemma shallow_tuples_rule__ElemAO__acc\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3) Generated_ShallowShared.ElemAO) (xt :: ('xt1, 'xt2, 'xt3) Generated_ShallowShared_Tuples.ElemAO) \<Longrightarrow>
   shallow_tuples_rel (Generated_ShallowShared.ElemAO.acc\<^sub>f x) (Generated_ShallowShared_Tuples.ElemAO.acc\<^sub>f xt)"
  by (simp add: shallow_tuples_rel_ElemAO_def)
lemma shallow_tuples_rule__ElemAO__obsv\<^sub>f [ShallowTuplesThms_Generated]:
  "shallow_tuples_rel (x :: ('x1, 'x2, 'x3) Generated_ShallowShared.ElemAO) (xt :: ('xt1, 'xt2, 'xt3) Generated_ShallowShared_Tuples.ElemAO) \<Longrightarrow>
   shallow_tuples_rel (Generated_ShallowShared.ElemAO.obsv\<^sub>f x) (Generated_ShallowShared_Tuples.ElemAO.obsv\<^sub>f xt)"
  by (simp add: shallow_tuples_rel_ElemAO_def)
