...
where
  "rename__assocs \<equiv> [((''binarySearch'', Nil, Nil), ''binarySearch''), ((''expstep'', Nil, Nil), ''expstep''), ((''expstop'', Nil, Nil), ''expstop''), ((''log2step'', Nil, Nil), ''log2step''), ((''log2stop'', Nil, Nil), ''log2stop''), ((''myexp'', Nil, Nil), ''myexp''), ((''mylog2'', Nil, Nil), ''mylog2''), ((''repeat'', [TPrim (Num U32), TPrim (Num U32)], []), ''repeat_1''), ((''repeat'', [TRecord [(''p1'', (TPrim (Num U32), Present)), (''p2'', (TPrim (Num U32), Present)), (''p3'', (TPrim Bool, Present))] Unboxed, TRecord [(''p1'', (TCon ''WordArray'' [TPrim (Num U32)] (Boxed ReadOnly None), Present)), (''p2'', (TPrim (Num U32), Present))] Unboxed], []), ''repeat_2''), ((''repeat'', [TRecord [(''p1'', (TPrim (Num U64), Present)), (''p2'', (TPrim (Num U64), Present))] Unboxed, TPrim (Num U64)], []), ''repeat_0''), ((''searchNext'', Nil, Nil), ''searchNext''), ((''searchStop'', Nil, Nil), ''searchStop''), ((''wordarray_get'', [TPrim (Num U32)], []), ''wordarray_get_0''), ((''wordarray_get_opt'', [TPrim (Num U32)], []), ''wordarray_get_opt_0''), ((''wordarray_get_opt32'', Nil, Nil), ''wordarray_get_opt32''), ((''wordarray_length'', [TPrim (Num U32)], []), ''wordarray_length_0''), ((''wordarray_put'', [TPrim (Num U32)], []), ''wordarray_put_0''), ((''wordarray_put32'', Nil, Nil), ''wordarray_put32'')]"
