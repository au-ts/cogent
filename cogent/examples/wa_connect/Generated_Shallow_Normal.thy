...
where
  "wordarray_free' ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 T0.ex\<^sub>f) (\<lambda>(ex,ds\<^sub>2). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>2 T0.obj\<^sub>f) (\<lambda>(obj,ds\<^sub>1). HOL.Let (RR.make ex obj) (\<lambda>an\<^sub>8\<^sub>3. wordarray_free an\<^sub>8\<^sub>3)))"

definition
  error :: "'b \<Rightarrow> ('b, 'a) R"
where
  "error ds\<^sub>0 \<equiv> HOL.Let ds\<^sub>0 (\<lambda>b. HOL.Let (R.Error b :: ('b, 'a) R) (\<lambda>an\<^sub>8\<^sub>6. an\<^sub>8\<^sub>6))"

definition
  safe_add32 :: "(32 word, 32 word) RR \<Rightarrow> (unit, 32 word) R"
where
  "safe_add32 ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 RR.p1\<^sub>f) (\<lambda>(a,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 RR.p2\<^sub>f) (\<lambda>(b,ds\<^sub>2). HOL.Let ((+) a b) (\<lambda>r. HOL.Let ((<) r a) (\<lambda>an\<^sub>9\<^sub>3. HOL.Let ((<) r b) (\<lambda>an\<^sub>9\<^sub>6. HOL.Let (an\<^sub>9\<^sub>3 \<or> an\<^sub>9\<^sub>6) (\<lambda>an\<^sub>9\<^sub>2. HOL.If an\<^sub>9\<^sub>2 (HOL.Let () (\<lambda>an\<^sub>1\<^sub>0\<^sub>0. HOL.Let (R.Error an\<^sub>1\<^sub>0\<^sub>0 :: (unit, 32 word) R) (\<lambda>an\<^sub>9\<^sub>9. an\<^sub>9\<^sub>9))) (HOL.Let (R.Success r :: (unit, 32 word) R) (\<lambda>an\<^sub>1\<^sub>0\<^sub>1. an\<^sub>1\<^sub>0\<^sub>1))))))))"

definition
  safe_add64 :: "(64 word, 64 word) RR \<Rightarrow> (unit, 64 word) R"
where
  "safe_add64 ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 RR.p1\<^sub>f) (\<lambda>(a,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 RR.p2\<^sub>f) (\<lambda>(b,ds\<^sub>2). HOL.Let ((+) a b) (\<lambda>r. HOL.Let ((<) r a) (\<lambda>an\<^sub>1\<^sub>0\<^sub>8. HOL.Let ((<) r b) (\<lambda>an\<^sub>1\<^sub>1\<^sub>1. HOL.Let (an\<^sub>1\<^sub>0\<^sub>8 \<or> an\<^sub>1\<^sub>1\<^sub>1) (\<lambda>an\<^sub>1\<^sub>0\<^sub>7. HOL.If an\<^sub>1\<^sub>0\<^sub>7 (HOL.Let () (\<lambda>an\<^sub>1\<^sub>1\<^sub>5. HOL.Let (R.Error an\<^sub>1\<^sub>1\<^sub>5 :: (unit, 64 word) R) (\<lambda>an\<^sub>1\<^sub>1\<^sub>4. an\<^sub>1\<^sub>1\<^sub>4))) (HOL.Let (R.Success r :: (unit, 64 word) R) (\<lambda>an\<^sub>1\<^sub>1\<^sub>6. an\<^sub>1\<^sub>1\<^sub>6))))))))"

definition
  safe_sub32 :: "(32 word, 32 word) RR \<Rightarrow> (unit, 32 word) R"
where
  "safe_sub32 ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 RR.p1\<^sub>f) (\<lambda>(a,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 RR.p2\<^sub>f) (\<lambda>(b,ds\<^sub>2). HOL.Let ((-) a b) (\<lambda>r. HOL.Let ((>) r a) (\<lambda>an\<^sub>1\<^sub>2\<^sub>2. HOL.If an\<^sub>1\<^sub>2\<^sub>2 (HOL.Let () (\<lambda>an\<^sub>1\<^sub>2\<^sub>6. HOL.Let (R.Error an\<^sub>1\<^sub>2\<^sub>6 :: (unit, 32 word) R) (\<lambda>an\<^sub>1\<^sub>2\<^sub>5. an\<^sub>1\<^sub>2\<^sub>5))) (HOL.Let (R.Success r :: (unit, 32 word) R) (\<lambda>an\<^sub>1\<^sub>2\<^sub>7. an\<^sub>1\<^sub>2\<^sub>7))))))"

definition
  safe_sub64 :: "(64 word, 64 word) RR \<Rightarrow> (unit, 64 word) R"
where
  "safe_sub64 ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 RR.p1\<^sub>f) (\<lambda>(a,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 RR.p2\<^sub>f) (\<lambda>(b,ds\<^sub>2). HOL.Let ((-) a b) (\<lambda>r. HOL.Let ((>) r a) (\<lambda>an\<^sub>1\<^sub>3\<^sub>3. HOL.If an\<^sub>1\<^sub>3\<^sub>3 (HOL.Let () (\<lambda>an\<^sub>1\<^sub>3\<^sub>7. HOL.Let (R.Error an\<^sub>1\<^sub>3\<^sub>7 :: (unit, 64 word) R) (\<lambda>an\<^sub>1\<^sub>3\<^sub>6. an\<^sub>1\<^sub>3\<^sub>6))) (HOL.Let (R.Success r :: (unit, 64 word) R) (\<lambda>an\<^sub>1\<^sub>3\<^sub>8. an\<^sub>1\<^sub>3\<^sub>8))))))"

definition
  success :: "'a \<Rightarrow> ('b, 'a) R"
where
  "success ds\<^sub>0 \<equiv> HOL.Let ds\<^sub>0 (\<lambda>a. HOL.Let (R.Success a :: ('b, 'a) R) (\<lambda>an\<^sub>1\<^sub>4\<^sub>0. an\<^sub>1\<^sub>4\<^sub>0))"

definition
  wordarray_clone :: "( SysState, 'a WordArray) RR \<Rightarrow> ( SysState, ( SysState, 'a WordArray) RR) R"
where
  "wordarray_clone ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 RR.p1\<^sub>f) (\<lambda>(ex,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 RR.p2\<^sub>f) (\<lambda>(src,ds\<^sub>2). HOL.Let (wordarray_length src) (\<lambda>size. HOL.Let (RR.make ex size) (\<lambda>an\<^sub>1\<^sub>4\<^sub>5. Let\<^sub>d\<^sub>s (wordarray_create an\<^sub>1\<^sub>4\<^sub>5) (\<lambda>ds\<^sub>3. case_R (\<lambda>ex. HOL.Let (R.Error ex :: ( SysState, ( SysState, 'a WordArray) RR) R) (\<lambda>an\<^sub>1\<^sub>4\<^sub>9. an\<^sub>1\<^sub>4\<^sub>9)) (\<lambda>ds\<^sub>5. HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>5 RR.p1\<^sub>f) (\<lambda>(ex,ds\<^sub>6). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>6 RR.p2\<^sub>f) (\<lambda>(dest,ds\<^sub>7). HOL.Let (0 :: 32 word) (\<lambda>an\<^sub>1\<^sub>6\<^sub>1. HOL.Let (0 :: 32 word) (\<lambda>an\<^sub>1\<^sub>6\<^sub>2. HOL.Let (WordArrayCopyP.make dest src an\<^sub>1\<^sub>6\<^sub>1 an\<^sub>1\<^sub>6\<^sub>2 size) (\<lambda>an\<^sub>1\<^sub>5\<^sub>8. HOL.Let (wordarray_copy an\<^sub>1\<^sub>5\<^sub>8) (\<lambda>an\<^sub>1\<^sub>5\<^sub>7. HOL.Let (RR.make ex an\<^sub>1\<^sub>5\<^sub>7) (\<lambda>an\<^sub>1\<^sub>5\<^sub>5. HOL.Let (R.Success an\<^sub>1\<^sub>5\<^sub>5 :: ( SysState, ( SysState, 'a WordArray) RR) R) (\<lambda>an\<^sub>1\<^sub>5\<^sub>2. an\<^sub>1\<^sub>5\<^sub>2))))))))) ds\<^sub>3)))))"

definition
  wordarray_get_bounded :: "('a WordArray, 32 word) RR \<Rightarrow> (unit, 'a) R"
where
  "wordarray_get_bounded ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 RR.p1\<^sub>f) (\<lambda>(arr,ds\<^sub>1). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>1 RR.p2\<^sub>f) (\<lambda>(idx,ds\<^sub>2). HOL.Let (wordarray_length arr) (\<lambda>an\<^sub>1\<^sub>6\<^sub>8. HOL.Let ((<) idx an\<^sub>1\<^sub>6\<^sub>8) (\<lambda>an\<^sub>1\<^sub>6\<^sub>6. HOL.If an\<^sub>1\<^sub>6\<^sub>6 (HOL.Let (RR.make arr idx) (\<lambda>an\<^sub>1\<^sub>7\<^sub>2. HOL.Let (wordarray_get an\<^sub>1\<^sub>7\<^sub>2) (\<lambda>an\<^sub>1\<^sub>7\<^sub>1. HOL.Let (R.Success an\<^sub>1\<^sub>7\<^sub>1 :: (unit, 'a) R) (\<lambda>an\<^sub>1\<^sub>7\<^sub>0. an\<^sub>1\<^sub>7\<^sub>0)))) (HOL.Let () (\<lambda>an\<^sub>1\<^sub>7\<^sub>6. HOL.Let (R.Error an\<^sub>1\<^sub>7\<^sub>6 :: (unit, 'a) R) (\<lambda>an\<^sub>1\<^sub>7\<^sub>5. an\<^sub>1\<^sub>7\<^sub>5)))))))"

definition
  optionToResult :: "(unit, 'a) Option \<Rightarrow> (unit, 'a) R"
where
  "optionToResult ds\<^sub>0 \<equiv> case_Option (\<lambda>ds\<^sub>1. Let\<^sub>d\<^sub>s ds\<^sub>1 (\<lambda>ds\<^sub>3. HOL.Let () (\<lambda>an\<^sub>1\<^sub>7\<^sub>9. HOL.Let (R.Error an\<^sub>1\<^sub>7\<^sub>9 :: (unit, 'a) R) (\<lambda>an\<^sub>1\<^sub>7\<^sub>8. an\<^sub>1\<^sub>7\<^sub>8)))) (\<lambda>a. HOL.Let (R.Success a :: (unit, 'a) R) (\<lambda>an\<^sub>1\<^sub>8\<^sub>1. an\<^sub>1\<^sub>8\<^sub>1)) ds\<^sub>0"

definition
  resultToOption :: "('e, 'a) R \<Rightarrow> (unit, 'a) Option"
where
  "resultToOption ds\<^sub>0 \<equiv> case_R (\<lambda>ds\<^sub>1. Let\<^sub>d\<^sub>s ds\<^sub>1 (\<lambda>ds\<^sub>3. HOL.Let () (\<lambda>an\<^sub>1\<^sub>8\<^sub>5. HOL.Let (Option.None an\<^sub>1\<^sub>8\<^sub>5 :: (unit, 'a) Option) (\<lambda>an\<^sub>1\<^sub>8\<^sub>4. an\<^sub>1\<^sub>8\<^sub>4)))) (\<lambda>a. HOL.Let (Option.Some a :: (unit, 'a) Option) (\<lambda>an\<^sub>1\<^sub>8\<^sub>7. an\<^sub>1\<^sub>8\<^sub>7)) ds\<^sub>0"

definition
  copy_n :: "('a, 32 word, 'a WordArray) ElemAO \<Rightarrow> ('a, 32 word) RR"
where
  "copy_n ds\<^sub>0 \<equiv> HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>0 ElemAO.elem\<^sub>f) (\<lambda>(elem,ds\<^sub>2). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>2 ElemAO.acc\<^sub>f) (\<lambda>(idx,ds\<^sub>3). HOL.Let (take\<^sub>c\<^sub>o\<^sub>g\<^sub>e\<^sub>n\<^sub>t ds\<^sub>3 ElemAO.obsv\<^sub>f) (\<lambda>(afrm,ds\<^sub>1). HOL.Let (RR.make afrm idx) (\<lambda>an\<^sub>1\<^sub>9\<^sub>3. HOL.Let (wordarray_get an\<^sub>1\<^sub>9\<^sub>3) (\<lambda>an\<^sub>1\<^sub>9\<^sub>2. HOL.Let (1 :: 32 word) (\<lambda>an\<^sub>1\<^sub>9\<^sub>8. HOL.Let ((+) idx an\<^sub>1\<^sub>9\<^sub>8) (\<lambda>an\<^sub>1\<^sub>9\<^sub>6. RR.make an\<^sub>1\<^sub>9\<^sub>2 an\<^sub>1\<^sub>9\<^sub>6)))))))"
